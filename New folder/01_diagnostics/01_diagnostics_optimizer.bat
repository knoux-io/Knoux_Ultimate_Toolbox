...
cls
%BLUE%========================================================%WHITE%
%BLUE%  🔧 أداة optimizer من قسم ""01_diagnostics""%WHITE%
%BLUE%========================================================%WHITE%

echo [INFO] تم تشغيل: ""01_diagnostics""_optimizer.bat
echo [INFO] القسم: ""01_diagnostics""
...
echo %GRAY%الملف: %~dp0""01_diagnostics""_optimizer.bat%WHITE%
